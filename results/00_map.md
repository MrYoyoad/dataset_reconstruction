...
| oracle ladder, raw privates | `results/oracle_ladder/` (28 cells, running) | N=8, r=64, k=32, T=400 | fp64 | reported per cell | E8-adjacent |
...
point an exact affine combination (coefficient sum 1.000000000, min equal to max), isolation rank 5 = `k - (N-1)`,
...
| oracle ladder (E8-adjacent) | 28 cells running, jobs 435271-435322 |
