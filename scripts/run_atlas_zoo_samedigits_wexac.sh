...
#BSUB -gpu "num=1"
#BSUB -W 4:00
#BSUB -o scripts/wexac_logs/atlas_zoo_sd_%J.out
#BSUB -e scripts/wexac_logs/atlas_zoo_sd_%J.err
#BSUB -J atlas_zoo_sd
...
python -u -m experiments.dataset_sensitivity.atlas_zoo --save --device cuda --dataset mnist --same_digits --out zoo_bank_samedigits.pth
