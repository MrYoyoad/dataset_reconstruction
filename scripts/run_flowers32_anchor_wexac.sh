...
#BSUB -o scripts/wexac_logs/flowers32_anchor_%J.out
#BSUB -e scripts/wexac_logs/flowers32_anchor_%J.err
#BSUB -J flowers32_anchor
...
for ACT in softplus gelu silu; do
  ...
  python -u -m experiments.run_anchor_sweep \
    ...
    --finetune_activation "$ACT" --save --skip_if_exists --device cuda
done
