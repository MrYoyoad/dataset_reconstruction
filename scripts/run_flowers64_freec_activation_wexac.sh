...
#BSUB -o scripts/wexac_logs/flowers64_freec_activation_%J.out
#BSUB -e scripts/wexac_logs/flowers64_freec_activation_%J.err
#BSUB -J flowers64_freec_activation
# REALISTIC free-c activation spectrum on flowers64: fine-tune with each activation (shapes delta-W),
...
for ACT in softplus silu gelu mish gelu_tanh elu celu tanh sigmoid selu hardswish leaky_relu relu; do
  echo ""; echo "########## flowers64 free-c act=$ACT r=8 N=2 ##########"; date
