...
#BSUB -gpu "num=1"
#BSUB -o scripts/wexac_logs/gb_e2e_mnist_N_%J.out
#BSUB -e scripts/wexac_logs/gb_e2e_mnist_N_%J.err
#BSUB -J gb_e2e_mnist_N
...
python -u -m experiments.gradient_bridge.phase2_e2e \
    --dataset mnist --npc_list 1 2 5 --activations softplus gelu --seed 42 \
