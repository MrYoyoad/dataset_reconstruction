...
#BSUB -o scripts/wexac_logs/flowers32_nrank_%J.out
#BSUB -e scripts/wexac_logs/flowers32_nrank_%J.err
#BSUB -J flowers32_nrank
...
for R in 4 8 16 32 64; do
  ...
  python -u -m experiments.run_experiment_b \
    ...
    --save_results --skip_if_exists --device cuda
done
